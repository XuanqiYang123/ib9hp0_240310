...
memberships_data$membership_type <- 
  sample(memberships_type$membership_type, as.numeric(nrow(memberships_data)), replace = T)
#Lookup membership_id
memberships_data <- merge(memberships_type, memberships_data, by = "membership_type") %>%
