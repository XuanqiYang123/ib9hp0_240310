...
![](images/group9_ER-Final ERD.png)
...
![](images/Screenshot%202024-03-18%20at%2017.44.13.png){width="616"}
...
data_uploads folder: Used to store raw data files for uploads. Files in this directory follow a clear naming convention, such as R_synth_customers_round1.csv and

R_synth_customers_round2.csv, in order to quickly identify the source of the data. The insertion of new data also follows this rule, ensuring consistent data management.

analysis_results folder: used to store the results of the data analysis.

docs folder : holds project documents such as the analysis report Markdown file (IB9HP0_9.Rmd ) and the project RStudio project file (ib9hp0_group_9.Rproj).
...
![](images/trigger_conditions.png){width="323"}
...
1.  We have not capture all the complexity of the e-commerce database because our ERD only include the key entities not other supporting entities for example purchase return
2.  It is not integrated throughout
